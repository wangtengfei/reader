...
public abstract class PluginApi {
	public static final String ACTION_REGISTER = "android.zjreader.action.plugin.REGISTER";
	public static final String ACTION_RUN = "android.zjreader.action.plugin.RUN";
