...
abstract class PopupPanel extends ZLApplication.PopupPanel {
	...
	PopupPanel(ZJReaderApp fbReader) {
		super(fbReader);
	}

	protected final ZJReaderApp getReader() {
		return (ZJReaderApp)Application;
	}
	...
	public abstract void createControlPanel(ZJReader activity, RelativeLayout root, PopupWindow.Location location);
}
