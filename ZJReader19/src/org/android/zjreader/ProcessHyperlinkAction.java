...
import org.android.zjreader.image.ImageViewActivity;
...
{
	private static final String ACTION_LINK_PREFIX = "zjreader-action://";

	ProcessHyperlinkAction(ZJReader baseActivity, ZJReaderApp fbreader)
	{
...
//					openInBrowser(hyperlink.Id);
	...
	// {
	// }
	// intent.setData(Uri.parse(NetworkLibrary.Instance().rewriteUrl(urlString,
	// externalUrl)));
	// try
	// {
	// BaseActivity.startActivity(intent);
