...
public class ColorProfile
{
	...
	public final ZLColorOption WhiteTextOption;
	...
	private ColorProfile(String name, ColorProfile base)
	{
		...
		WhiteTextOption.setValue(base.WhiteTextOption.getValue());
	}
	...
	private ColorProfile(String name)
	{
		if (NIGHT.equals(name))
		{
			...
			WhiteTextOption = createOption(name, "FooterFillOption", 215, 215, 215);
		} else
		{
			...
			WhiteTextOption = createOption(name, "FooterFillOption", 15, 15, 15);
		}
	}
}
