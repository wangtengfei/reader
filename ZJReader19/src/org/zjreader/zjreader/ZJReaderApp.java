...
public final class ZJReaderApp extends ZLApplication
{
	...
	public ZLColorOption ImageViewBackgroundOption = new ZLColorOption("Colors", "ImageViewBackground", new ZLColor(127, 127, 127));
	...
	public final ZLIntegerRangeOption LeftMarginOption = new ZLIntegerRangeOption("Options", "LeftMargin", 0, 30, 4);
	public final ZLIntegerRangeOption RightMarginOption = new ZLIntegerRangeOption("Options", "RightMargin", 0, 30, 4);
	public final ZLIntegerRangeOption TopMarginOption = new ZLIntegerRangeOption("Options", "TopMargin", 0, 30, 0);
	public final ZLIntegerRangeOption BottomMarginOption = new ZLIntegerRangeOption("Options", "BottomMargin", 0, 30, 4);
	...
	public final ZLIntegerRangeOption FooterHeightOption = new ZLIntegerRangeOption("Options", "FooterHeight", 8, 24, 24);
	...
	public void initWindow()
	{
		...
		wait("loadingBook", new Runnable()
		{
			public void run()
			{
				...
				if (Const.isCode)
				{
					System.out.println(Const.isCode);
	...
	{
		myColorProfile.WallpaperOption = new ZLStringOption("Colors", ColorProfile.NIGHT + ":Wallpaper", "");
		myColorProfile.BackgroundOption.setValue(new ZLColor(r, g, b));
	}
	...
	public List<CancelActionDescription> getCancelActionsList()
	{
		...
		if (ShowPreviousBookInCancelMenuOption.getValue())
		{
			...
			{
				myCancelActionsList.add(new CancelActionDescription(CancelActionType.previousBook, previousBook.getTitle()));
			}
		}
