...
import com.rdweiba.main.pagesview.FindResult;
...
public class PDF
{
	 ...
	 */
	synchronized public native int[] renderPage(int n, int zoom, int left, int top, int rotation, boolean gray, boolean skipImages, PDF.Size rect);
