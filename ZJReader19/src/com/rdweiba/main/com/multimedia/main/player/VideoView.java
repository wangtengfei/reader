...
public class VideoView extends SurfaceView implements MediaPlayerControl
{
	...
	public void setVideoPath(String path)
	{
		...
		try
		{
			setVideoInputStream(new FileInputStream(path));
		} catch (FileNotFoundException e)
		{
			Log.e("@ZZZ", "filepath not FOUND!!!", e);
		}
	}

	/*
	 * public void setVideoURI(Uri uri) { mUri = uri; mStartWhenPrepared =
	 * false; mSeekWhenPrepared = 0; openVideo(); requestLayout(); invalidate();
	 * }
	 */

	public void setVideoInputStream(FileInputStream inputStream)
	{
	...
	{
		if (mIsPrepared && keyCode != KeyEvent.KEYCODE_BACK && keyCode != KeyEvent.KEYCODE_VOLUME_UP && keyCode != KeyEvent.KEYCODE_VOLUME_DOWN && keyCode != KeyEvent.KEYCODE_MENU
				&& keyCode != KeyEvent.KEYCODE_CALL && keyCode != KeyEvent.KEYCODE_ENDCALL && mMediaPlayer != null && mMediaController != null)
		{
