...
public  class MohoVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    public MohoVideoView(Context context) {
        super(context);
        mContext = context;
        initVideoView();
    }
    
    public MohoVideoView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        mContext = context;
        initVideoView();
    }
    
    public MohoVideoView(Context context, AttributeSet attrs, int defStyle) {
